...
#define ELEM_EPSILON FLT_EPSILON
    ...
    extern const int32_t occ_hm_side_len = 8;
    ...
    typedef struct
    {
        ...
        time_t timestamp;
        ID_TYPE id : 12;
        uint8_t cmf : 3; // continuous matched frmaes
        uint8_t is_stable : 1;
        age_t age;
        uint8_t stay_cont;
    } customer_t;
    ...
    {
        occlusion_point *occ;
        occlusion_point *last_occ;
        index_t tracks[8]; /**배열의 수 중요, occ_grid_max_cap 참고**/
        index_t track_num;
    } hm_node;
