...
//********************************************************//
double HungarianAlgorithm::Solve(ELEM_T* DistMatrix, index_t* Assignment, index_t trk_num, index_t det_num, index_t ldm)
{
	...
	for (unsigned int i = 0; i < nRows; i++)
		for (unsigned int j = 0; j < nCols; j++)
			distMatrixIn[i + nRows * j] = DistMatrix[i * ldm + j];
